...
$ttexts = [
    [ "fr", "en" ],
    [ "Vous (%s) avez choisi la team %s !", "You (%s) have chosen %s team!"],
    [ "Vous (%s) n'avez pas choisi d'équipe !", "You (%s) didn't choose any team!"],
    [ "L'équipe %s n'existe pas...", "The %s team doesn't exist..."],
